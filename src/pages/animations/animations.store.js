...
export const showKeyframeDropdownMenu = (state, { position, id }) => {
  state.dropdownMenu = {
    isOpen: true,
    position,
    items: [{
...
export const setTimelinePreviewMousePosition = (state, { x }) => {
  state.timelinePreview.isShown = true;
  state.timelinePreview.position.x = x;
}
