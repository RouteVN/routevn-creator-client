...
const themeOptions = [
  {
    ...
    previewPageBackground: "oklch(0.26 0 0)",
    previewPanelBackground: "oklch(0.3 0 0)",
    previewCardBackground: "oklch(0.36 0 0)",
    previewAccent: "oklch(0.42 0 0)",
    previewPrimary: "oklch(0.9 0 0)",
    previewSecondary: "oklch(0.36 0 0)",
