...
export const handleBeforeMount = (deps) => {
  ...
  const zoomLevel = userConfig.get("groupPlacementsView.zoomLevel");
...
export const handleZoomChange = (e, deps) => {
  ...
  userConfig.set("groupPlacementsView.zoomLevel", zoomLevel.toFixed(1));
...
export const handleZoomOut = (e, deps) => {
  ...
  userConfig.set("groupPlacementsView.zoomLevel", newZoom.toFixed(1));
